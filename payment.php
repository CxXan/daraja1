...
<head>
    ...
    <title>Sony Sugar | Transactions</title>
    ...
    <div class="dashboard">
        ...
        <div class="transactions">
            <div class="ovfl">
                ...
                <?php
                $transact_qy = mysqli_query($connection, "select * from farmers_payment where id={$_SESSION['farmer_id']}");
                if($transact_qy && mysqli_num_rows($transact_qy)>0){
                    while($trsn = mysqli_fetch_assoc($transact_qy)){
                    ?>
                <div class="case_data_sty flex-row">
                    <p><span><?php echo "PMSY" . $trsn['payment_id'] ?></span></p>
                    <p><?php echo $trsn['pay_amount'] . " Ksh";?></p>
                    <p><?php echo $trsn['pay_date']; ?></p>
                </div>
                    <?php
                    }
                }
                    ...
                    ?>
                <div class="case_data_sty flex-row">
                    <p style="margin-left: 25rem; letter-spacing: 2.4px;">NO PAYMENT DETAILS TO DISPLAY.</p>
                </div>
                    <?php
                }
                ?>
