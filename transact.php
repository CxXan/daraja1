...
<body>
    <div class="dashboard">
        ...
        <div class="transactions">
            <div class="ovfl">
                <?php
                $payment_qy = mysqli_query($connection, "select * from transactions");
                if($payment_qy && mysqli_num_rows($payment_qy)>0){
                    ?>
                <div class="case_data_sty flex-row">
                    <p>transaction - <span>01</span> :</p>
                    <p>transaction - <span>01</span> :</p>
                    <p>transaction - <span>01</span> :</p>
                </div>
                    <?php
                ...
                <div class="case_data_sty p-align flex-row">
                    <p style="margin-left: 25rem; letter-spacing: 2.4px;">NO TRANSACTIONS DETAILS TO DISPLAY.</p>
                </div>
                    <?php
                }
                ?>
